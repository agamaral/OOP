...
public class Main {
	...
	public static void main(final String[] args) {
		...
		Aluno a1 = new Aluno("Antônio", 234, 1,"Engenharia");
		...
		while(true) {
			...
			System.out.println("(7) EXIBIR ALUNOS ACIMA DAS MÉDIA");
			System.out.println("(8) EXIBIR ALUNOS ABAIXO DA MÉDIA");
			System.out.println("(9) EXIBIR NOTAS, NOMES E FREQUÊNCIAS");
			...
			while(op != 0) {
				switch (op) {
					...
					case 2:
						System.out.println("O num de alunos é:"+c1.getNumAlunos());
						System.out.println("O num de alunos reprovados é:"+c1.getNumReprovados());
						System.out.println("O num de alunos aprovados é:"+c1.getNumAprovados());
					...
					case 5: // half working
						...
						System.out.println("A maior nota é:" +c1.exibirMaiorNota());
						System.out.println("A menor nota é:" +c1.exibirMenorNota());
						break;
					...
					case 7:
						...
						System.out.println("A media é:" +c1.calcularMedia());
